...
fspan=fstop-fstart    #Bande de Measurement
RBW=1e6       #Resolution du filtre de FI
VBW=1e6       #Filtre vidéo
SWP=40          #Temps de balayage
Tmes=60
...
for i in range(0,len(Angles)):
    ...
    print 'N = %3d, f = %2.2f MHz, Pmes= %2.2f dBm, Pt= %2.2f mW/MHz' %(i+1,Maximumf/1e6,MaximumLevel,1000*TotalP.max())
    savez(nom,Angles=Angles,f=f,Measurement=Measurement,Raw_Measurement=Raw_Measurement)
...
savez(nom,Angles=Angles,f=f,Measurement=Measurement,Raw_Measurement=Raw_Measurement,Qcal=Qcal,Pt=Pt)
